<template>
  <div class="dashboard">
    ...
    <v-alert dense text type="info">
      <strong>Info: </strong> Omdat je bent ingelogd als beheerder kun je gegevens weergeven en bewerken. Vergeet dus niet uit te loggen.
    </v-alert>
    <v-card elevation="2" class="rounded-lg mb-4">
        ...
        <v-card-subtitle>
            Je kunt deze aanpassen in de <router-link to="/settings/navigation" v-slot="{href, navigate}">
            <NavLink :href="href" @click="navigate">instellingen</NavLink></router-link>.
        </v-card-subtitle>
    </v-card>
    <v-row>
      <v-col lg="7" cols="12">
